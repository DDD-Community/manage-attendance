...
SWAGGER_SETTINGS = {
    ...
    'TAGS': [
        {'name': 'health-check', 'description': '서버 상태 확인 관련 작업'},
        {'name': 'auth', 'description': '사용자 인증 관련 작업'},
        {'name': 'invite-code', 'description': '초대코드 관련 작업'},
        {'name': 'user', 'description': '사용자 등록 및 관리 관련 작업'},
        {'name': 'qr', 'description': 'QR 코드 관련 작업'},
        {'name': 'schedule', 'description': '스케쥴 관련 작업'},
