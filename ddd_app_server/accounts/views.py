...
class GoogleLoginCallback(APIView):
    def get(self, request, *args, **kwargs):
        ...
        token_endpoint_url = urljoin("https://localhost:8000", reverse("google_login"))
        respose = requests.post(token_endpoint_url, data={"code": code})
        
        return Response(respose.json(), status=status.HTTP_200_OK)
